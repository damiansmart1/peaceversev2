      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-120px)] px-4">
        ...
        <div className="w-full max-w-md bg-muted/40 backdrop-blur-lg rounded-lg border border-primary-foreground/20 p-8">
          <form onSubmit={isSignUp ? handleSignUp : handleSignIn} className="space-y-6">
            ...
            <div className="space-y-2">
              <Input type="password" placeholder={t('auth.password')} value={password} onChange={e => setPassword(e.target.value)} required className="h-12 bg-background/50 border-primary-foreground/30 text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-primary" />
            </div>
