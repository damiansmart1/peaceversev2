...
import { Volume2, Eye, Type, Languages, Headphones, Accessibility, Wifi, WifiOff, Smartphone, Globe, Mic, MessageSquare } from "lucide-react";
...
const AccessibilityFeatures = () => {
  ...
  return <section className="space-y-12">
      <div className="relative w-full rounded-lg overflow-hidden h-80">
        <img src={accessibilityInclusion} alt="Diverse people including those with disabilities participating equally in community activities" className="w-full h-full object-cover" style={{
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        return <Card key={index} className="p-5 hover:shadow-elevated transition-all duration-300">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <Slider value={textSize} onValueChange={setTextSize} max={200} min={75} step={25} className="w-full" />
              </div>

              <div className="flex items-center space-x-2 p-3 bg-muted rounded-lg">
                <Type className="w-4 h-4 text-muted-foreground" />
                <span className="text-sm text-card-foreground" style={{
                fontSize: `${textSize[0]}%`
              }}>
      ...
      <Card className="p-6 bg-card/80 backdrop-blur-sm border-accent/20 shadow-story">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            {languages.map(lang => <Button key={lang.code} variant="outline" className="justify-start space-x-3 h-auto p-3">
      ...
      <Card className="p-8 bg-story-gradient border-accent/20 shadow-story">
        <div className="text-center space-y-4">
          ...
          <p className="leading-relaxed max-w-2xl mx-auto text-white">
