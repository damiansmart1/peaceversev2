...
const DonorShowcase = () => {
  const partnerCategories = [
    {
      ...
      icon: Globe,
      partners: [
        { name: "African Union", type: "Strategic Partner", description: "Continental coordination and policy alignment" },
        { name: "United Nations", type: "Technical Partner", description: "Integration with UN early warning mechanisms" },
        { name: "ECOWAS", type: "Regional Partner", description: "West African conflict prevention collaboration" },
        { name: "IGAD", type: "Regional Partner", description: "Horn of Africa security coordination" },
      ]
    },
    {
      ...
      icon: Building2,
      partners: [
        { name: "Kenya Ministry of Interior", type: "National Partner", description: "Pilot country implementation" },
        { name: "Rwanda Peace Commission", type: "National Partner", description: "Community reconciliation integration" },
        { name: "Ghana National Peace Council", type: "National Partner", description: "Election monitoring support" },
        { name: "South Africa DPCI", type: "National Partner", description: "Cross-border crime intelligence" },
      ]
    },
    {
      ...
      icon: Shield,
      partners: [
        { name: "African Leadership University", type: "Research Partner", description: "Data analysis and academic research" },
        { name: "iHub Kenya", type: "Tech Partner", description: "Innovation and product development" },
        { name: "Andela", type: "Tech Partner", description: "Engineering talent and capacity building" },
        { name: "Google.org", type: "Funding Partner", description: "AI and machine learning support" },
      ]
    }
  ];
  ...
  const impactStats = [
    { value: "47", label: "Active Countries" },
    { value: "$2.4M", label: "Funds Deployed" },
    { value: "340+", label: "Conflicts Prevented" },
    { value: "156K", label: "Users Protected" },
  ];
    ...
    <section className="space-y-12">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {impactStats.map((stat, index) => (
          <Card key={index} className="p-6 text-center bg-gradient-to-br from-primary/5 to-accent/5 border-primary/10">
      ...
      <div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {supportTiers.map((tier, index) => (
            <Card key={index} className="p-6 hover:shadow-elevated transition-all duration-300 border-2 hover:border-primary/20">
      ...
      <Card className="p-6 bg-muted/50">
        <div className="text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Badge className="bg-primary/10 text-primary px-4 py-2">AU Innovation Award 2024</Badge>
